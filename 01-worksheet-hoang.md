...
|---|---|---|---|
| 1 | **Vinpearl** | Lặp lại (Repetitive) | Nhân viên tổng đài phải tốn hàng giờ mỗi ngày để đọc, nghe và phân loại thủ công hàng ngàn yêu cầu hỗn tạp (đặt vé, hoàn tiền, lỗi kỹ thuật) trước khi chuyển đi, gây lãng phí nhân lực và tạo độ trễ lớn trong khâu tiếp nhận. |
...
| 3 | **VinFast** | Tốn thời gian (Time-consuming) | Quy trình xét duyệt bảo hành bị ách tắc nghiêm trọng. Kỹ thuật viên phải đối chiếu thủ công bằng mắt các video, hình ảnh xước/hỏng và giấy tờ với cẩm nang tiêu chuẩn công ty, ngốn tới 45 phút/case khiến khách hàng phàn nàn vì chờ đợi. |
| 4 | **Xanh SM** | AI-upgrade | Đội ngũ giám sát an toàn bị "mù" thông tin cảnh báo sớm. Dù sở hữu kho dữ liệu thô khổng lồ (GPS, gia tốc, hành vi phanh), họ không thể phân tích kịp thời để phát hiện và ngăn chặn các tài xế đang kiệt sức hoặc lái ẩu, tiềm ẩn rủi ro tai nạn lớn. |
| 5 | **Vinmec** | Tốn thời gian (Time-consuming) | Bác sĩ bị vắt kiệt sức bởi gánh nặng hành chính khi phải gõ tay và tra cứu chéo bệnh lý/hóa đơn để soạn đơn chỉ định xét nghiệm. Tác vụ này ngốn 10-15 phút/đơn (hơn 200 đơn/ngày), làm suy giảm trực tiếp thời gian thực tế thăm khám bệnh nhân. |
...
│                                                             │
│ Bài toán: Phân loại ý định và điều hướng tự động khiếu nại, │
│ phản hồi của cư dân trên ứng dụng Vinhomes Resident.        │
│ Công ty thành viên: [x] Vinhomes                            │
│                                                             │
│ Ai đang đau? Nhân viên CSKH (quá tải), Cư dân (chờ đợi)     │
│                                                             │
│ Workflow thủ công hiện tại (5 bước):                        │
│   1. Cư dân gửi text/ảnh khiếu nại qua App                  │
│   → 2. Nhân viên CSKH đọc/xem thủ công để hiểu vấn đề       │
│   → 3. Quyết định phân luồng (Kỹ thuật, An ninh, Vệ sinh...)│
│   → 4. Chuyển ticket về đúng ban phụ trách trên hệ thống    │
│   → 5. Copy-paste câu phản hồi rập khuôn thông báo tiếp nhận│
│                                                             │
│ Bước nào tốn nhất? Bước 2-3-4 (⏱ 10 phút/ticket)          │
│ AI có thể nhảy vào hỗ trợ ở bước nào? Bước 2-3-5            │
│ (Tự động đọc hiểu ngữ nghĩa -> Gắn tag phân loại -> Đẩy     │
│  ticket về đúng ban -> Draft phản hồi cá nhân hóa)          │
│                                                             │
│ Đo thành công bằng gì (Metric có số)?                       │
│ Giảm thời gian chờ tiếp nhận và phân luồng từ 12 tiếng ──>  │
│ dưới 5 phút. Tỷ lệ route đúng ban đạt > 95%.                │
│                                                             │
│ Quick Architecture: [x] LLM Feature (Phân loại & Soạn nháp) │
└─────────────────────────────────────────────────────────────┘
```
┌─────────────────────────────────────────────────────────────┐
│ QUICK PROBLEM CARD #2                                       │
│                                                             │
│ Bài toán: Số hóa, trích xuất cấu trúc và tóm tắt hồ sơ      │
│ xuất viện từ lịch sử khám bệnh và xét nghiệm phức tạp.      │
│ Công ty thành viên: [x] Vinmec                              │
│                                                             │
│ Ai đang đau? Bác sĩ (kiệt sức vì việc hành chính)           │
│                                                             │
│ Workflow thủ công hiện tại (4 bước):                        │
│   1. Bác sĩ nhận thông báo bệnh nhân chuẩn bị xuất viện     │
│   → 2. Lật giở hệ thống, đọc lại toàn bộ kết quả xét nghiệm,│
│        chẩn đoán, thuốc đã dùng trong nhiều ngày qua        │
│   → 3. Gõ tay tổng hợp các chỉ số quan trọng, tình trạng    │
│        lâm sàng và tiền sử bệnh nền vào biên bản            │
│   → 4. In, ký duyệt và đẩy lên hệ thống hồ sơ điện tử       │
│                                                             │
│ Bước nào tốn nhất? Bước 2-3 (⏱ 25 phút/bệnh nhân)         │
│ AI có thể nhảy vào hỗ trợ ở bước nào? Bước 2-3              │
│ (Quét toàn bộ text/log khám -> Trích xuất chỉ số chính ->   │
│  Sinh bản nháp tóm tắt diễn biến lâm sàng)                  │
│                                                             │
│ Đo thành công bằng gì (Metric có số)?                       │
│ Giảm thời gian làm hồ sơ xuất viện từ 25 phút ──> dưới 5    │
│ phút. Tỷ lệ bỏ sót cảnh báo dị ứng/bệnh nền là 0%.          │
│                                                             │
...
│                                                             │
│ Bài toán: Phân tích ngữ nghĩa từ ghi âm/ghi chú hàng ngàn   │
│ cuốc xe bị hủy mỗi ngày để tìm lỗi hệ thống (pattern).      │
│ Công ty thành viên: [x] Xanh SM (GSM)                       │
│                                                             │
│ Ai đang đau? QA/Vận hành (mù data), Khách hàng (trải nghiệm)│
│                                                             │
│ Workflow thủ công hiện tại (4 bước):                        │
│   1. Xuất file log hàng ngàn cuốc xe hủy mỗi ngày           │
│   → 2. QA nghe lại ngẫu nhiên các cuốc có ghi âm tổng đài   │
│   → 3. Đọc ghi chú text của tài xế trên app                 │
│   → 4. Gắn tag lý do hủy (lỗi app, tắc đường, khách đổi ý)  │
│        vào báo cáo Excel bằng tay                           │
│                                                             │
│ Bước nào tốn nhất? Bước 2-3-4 (⏱ 10 phút/cuốc, nhân lực   │
│ thủ công hiện tại chỉ cover được < 5% lượng dữ liệu)        │
│ AI có thể nhảy vào hỗ trợ ở bước nào? Bước 2-3-4            │
│ (Speech-to-text tự động -> LLM đọc hiểu ngữ cảnh -> Tự động │
│  gắn tag lý do hủy và gom nhóm các lỗi giống nhau)          │
│                                                             │
│ Đo thành công bằng gì (Metric có số)?                       │
│ Tăng tỷ lệ bao phủ dữ liệu (coverage) phân tích lý do hủy   │
│ từ 5% ──> 100%. Thời gian phân tích < 10 giây/cuốc.         │
│                                                             │
│ Quick Architecture: [x] LLM Feature (Text/Audio Analytics)  │
└─────────────────────────────────────────────────────────────┘
